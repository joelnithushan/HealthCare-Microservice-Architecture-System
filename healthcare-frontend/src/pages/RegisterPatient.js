      ...
      try {
        ...
        toast.error(
          regErr.response?.data?.message ||
            "Registration failed. Email or NIC might be taken.",
        );
        setShowOtpModal(false);
      }
    } catch (err) {
      ...
      <div style={styles.cardContainer}>
        <div style={styles.brandPanel}>
          ...
          <p style={styles.brandSub}>
            Register securely using your Sri Lankan national identity
            credentials to organize all your health profiles safely.
          </p>
        </div>
        ...
        <div style={styles.formPanel}>
          ...
          <p style={styles.formSub}>
            Looking for Doctor Registration?{" "}
            <Link to="/register/doctor" style={styles.switchLink}>
              Click Here
            </Link>
          </p>
