...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (errorMsg.includes('account has been suspended')) {
    ...
    <div style={styles.pageWrapper}>
      <div style={styles.cardContainer}>
        ...
        <div style={styles.brandPanel}>
          ...
          <h2 style={styles.brandTitle}>Welcome to Medi Connect</h2>
          <p style={styles.brandSub}>
            Book appointments and access telemedicine services from Sri Lanka's leading healthcare professionals.
          </p>
        </div>
        ...
        <div style={styles.formPanel}>
          ...
          <p style={styles.formSub}>Please enter your email and password to login</p>
